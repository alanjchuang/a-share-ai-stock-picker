...
def data_health(conn=Depends(get_db)) -> ApiResponse[DataHealthResponse]:
    ...
    payload = DataHealthResponse(
        ...
        startup_sync_enabled=settings.scheduler.startup_sync_enabled,
        incremental_sync_minutes=settings.scheduler.incremental_sync_minutes,
        incremental_sync_lookback_days=settings.scheduler.incremental_sync_lookback_days,
